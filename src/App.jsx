                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {!isFinalizado && (
                            <button
                              ...
                              className="text-zinc-500 hover:text-red-400 transition-colors p-1 bg-white/5 rounded-full"
                ...
                {!isFinalizado ? (
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      disabled={loadingWinner}
                      className="text-[#f2cc0d] hover:text-white p-2 rounded-lg bg-[#f2cc0d]/10 hover:bg-[#f2cc0d]/20 transition-colors"
